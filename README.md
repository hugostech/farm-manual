...
This project is a comprehensive Books Management System built using Laravel and Soft UI Dashboard. It allows administrators to manage books by creating, editing, and deleting them. Additionally, it provides a subscription management system for readers, controlling which books they can access based on their subscription.

## Features

- **Books Management**: Admins can create, edit, and delete books.
