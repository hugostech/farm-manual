...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('admin') ? 'active' : '') }}" href="{{ url('dashboard') }}">
      ...
      <li class="nav-item">
        ...
        @foreach(\App\Models\Book::availableBooksForUser(\Illuminate\Support\Facades\Auth::user()) as $book)
              <li class="nav-item">
                <a class="nav-link {{ (Request::is(route('books.show', ['book'=>$book])) ? 'active' : '') }}"
                  ...
                  <span class="nav-link-text ms-1">{{$book->title}}</span>
                </a>
              </li>
        @endforeach
