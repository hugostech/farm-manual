            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">Today's Active User</p>
                                <h5 class="font-weight-bolder mb-0">
                                    {{\App\Models\User::whereBetween('last_login_at', [\Carbon\Carbon::today()->startOfDay(), \Carbon\Carbon::today()->endOfDay()])->count()}}
                    ...
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                ...
                                <h5 class="font-weight-bolder mb-0">
                                    {{number_format(\App\Models\Book::count())}}
                ...
                <div class="card-header pb-0">
                    <div class="row">
                        <div class="col-lg-6 col-7">
                            <h6>Most Popular Manuals</h6>
                            <p class="text-sm mb-0">
                                <i class="fa fa-check text-info" aria-hidden="true"></i>
                                <span class="font-weight-bold ms-1">{{\App\Models\UserBookHistory::today()->pluck('user_id')->unique()->count()}} active readers</span> today
                            </p>
                        </div>
                                ...
                                @foreach(\App\Models\Book::all() as $book)
                                    ...
                                    <td>
                                        <div class="avatar-group mt-2">
                                            @foreach($book->todayReaders->take(10) as $user)
